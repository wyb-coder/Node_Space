...
from .models import yonghu, zhaopinxinxi, zhaopinxinxiRecomm
...
def yonghu_register(request):
    if request.method in ["POST", "GET"]:
        ...
        # 获取req_dict中yonghuming的值
        yonghuName = req_dict.get(list(req_dict.keys())[1])
        data1 = zhaopinxinxi.getbyid(zhaopinxinxiRecomm, zhaopinxinxiRecomm, 1)

        # 删除data1中的‘id’
        del data1[0]['id']
        data1[0]['yonghuName'] = yonghuName

        zhaopinxinxi.insertzhaopinxinxiRecomm(zhaopinxinxiRecomm, zhaopinxinxiRecomm, data1[0])

        print("\n\n" + "data1: ", data1)

        data2 = zhaopinxinxi.getbyid(zhaopinxinxiRecomm, zhaopinxinxiRecomm, 1)
        print("\n\n" + "data2: ", data2)
...
def yonghu_login(request):
    if request.method in ["POST", "GET"]:
        ...
        loginUserName = datas[0].get('yonghuming')
...
def yonghu_delete(request):
    ...
    if request.method in ["POST", "GET"]:
        ...
        yonghuId = req_dict.get("ids")
        data1 = yonghu.getbyid(yonghu, yonghu, int(yonghuId[0]))
        # print(data1)
        # 取出yonghuming
        yonghuName = data1[0].get('yonghuming')
        # print("\n\n" + "yonghuName: ", yonghuName)
        zhaopinxinxi.deletebyonghuname(zhaopinxinxiRecomm, zhaopinxinxiRecomm, yonghuName)
