  ...
  <div>
    ...
    >
      <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' label="原密码" prop="password">
        <label slot="label" style="font-size: 20px;">原密码</label>
        <el-input v-model="ruleForm.password" show-password></el-input>
      </el-form-item>
      <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' label="新密码" prop="newpassword">
        <label slot="label" style="font-size: 20px;">新密码</label>
      ...
      <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' label="确认密码" prop="repassword">
        <label slot="label" style="font-size: 18px;">确认密码</label>
        <el-input v-model="ruleForm.repassword" show-password></el-input>
      </el-form-item>
      <el-form-item :style='{"width":"100%","padding":"0","margin":"0"}'>
        <el-button :style='{"border":"0","cursor":"pointer","padding":"0","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"30px","background":"#93C7B3","width":"128px","lineHeight":"40px","fontSize":"18px","height":"40px"}' type="primary" @click="onUpdateHandler">确 定</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
