...
<div :style='{"width":"1100px","padding":"30px","margin":"10px auto","position":"relative","background":"#efefef"}'>
    <div class="section-title" :style='{"margin":"10px 0","color":"#fff","borderRadius":"50px","textAlign":"center","background":"#000","fontSize":"24px","lineHeight":"54px"}'>留言板</div>
	<el-form :model="form" :rules="rules" ref="form" label-width="65px" label-position="left">
	  <el-form-item label="留言" prop="content">
		<label slot="label" style="font-size: 20px;">留言</label>
		<el-input type="textarea" :rows="5" v-model="form.content" placeholder="请输入内容"></el-input>
	  </el-form-item>
      <el-form-item label="图片" prop="cpicture">
		<label slot="label" style="font-size: 20px;">图片</label>
        <file-upload
        tip="点击上传图片"
        action="file/upload"
        :limit="1"
