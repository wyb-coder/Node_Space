		...
		<div class="attr" :style='{"minHeight":"520px","padding":"20px","position":"relative","flexDirection":"row-reverse","display":"flex"}'>
			...
			<div class="info" :style='{"width":"640px","padding":"30px 20px","margin":"0 0 0 10px","background":"rgba(245, 245, 245, 1)"}'>
				...
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					...
					<div  :style='{"padding":"0 10px","color":"#000","borderRadius":"10px","background":"rgba(0, 0, 0, 0.15)","width":"498px","fontSize":"14px","lineHeight":"40px","height":"auto"}'>{{detail.refid}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					...
					<div  :style='{"padding":"0 10px","color":"#000","borderRadius":"10px","background":"rgba(0, 0, 0, 0.15)","width":"498px","fontSize":"14px","lineHeight":"40px","height":"auto"}'>{{detail.nickname}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					...
					<div  :style='{"padding":"0 10px","color":"#000","borderRadius":"10px","background":"rgba(0, 0, 0, 0.15)","width":"498px","fontSize":"14px","lineHeight":"40px","height":"auto"}'>{{detail.content}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					...
					<div  :style='{"padding":"0 10px","color":"#000","borderRadius":"10px","background":"rgba(0, 0, 0, 0.15)","width":"498px","fontSize":"14px","lineHeight":"40px","height":"auto"}'>{{detail.reply}}</div>
				</div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getDiscussList(page) {
        this.$http.get('discussdiscusszhaopinxinxi/list', {params: {page, limit: this.pageSize, refid: this.detail.id}}).then(res => {
          if (res.data.code == 0) {
      ...
      submitForm(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            this.$http.post('discussdiscusszhaopinxinxi/add', this.form).then(res => {
              if (res.data.code == 0) {
                this.form.content = '';
                this.getDiscussList(1);
                this.$message({
