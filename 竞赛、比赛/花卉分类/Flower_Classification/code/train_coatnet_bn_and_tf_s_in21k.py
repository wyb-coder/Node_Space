...
DEFAULT_CONFIG: Dict[str, Any] = {
	"seed": 42,
	"experiment_name": "flower_coatnetbn_effv2",
	...
	"model": {
		"name": "coatnet_bn0",
		"backbone": "coatnet_bn_0_rw_224.sw_in1k",
		"pretrained_file": "coatnet_bn_0_rw_224.sw_in1k.bin",
		"drop_path": 0.2,
		"checkpoint": None,
	...
	"train": {
		...
		"pin_memory": True,
		"stages": [
			{"start_epoch": 0, "epochs": 16, "img_size": 224, "mixup": 0.2, "cutmix": 0.8},
			{"start_epoch": 16, "epochs": 20, "img_size": 320, "mixup": 0.2, "cutmix": 0.6, "batch_per_gpu": 32},
		],
