...
\zihao{5-}
\songti 
第1卷\quad 第1期 \hfill 计\quad 算\quad 机\quad 学\quad 报\hfill Vol. 48  No. 11
\zihao{5-}\songti  
2025年11月 \hfill CHINESE JOURNAL OF COMPUTERS \hfill ???. 20?? \\
\hline\\[-4.5mm]
\hline\end{tabular}
...
\vspace{11mm}
\heiti  
{\zihao{2} AMR-SELOR: 一种用于生成语义逻辑解释的神经符号框架}

\vskip 5mm

{\zihao{3} \fangsong 
王耀彬$^{1)}$\quad  刘杰$^{2)}$ \quad 
 }

\vspace{5mm}
\zihao{6}{\songti 
$^{1)}$(北方工业大学人工智能与计算机学院，北京市石景山区晋元庄路5号，100144
 }
